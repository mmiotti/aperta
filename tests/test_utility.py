...
Run with:
    python -m unittest tests.test_utility
"""
...
class RouteUtilityTestCase(unittest.TestCase):
    ...
    def test_cost_only(self):
        ...
        out = route_utility(g, pairs, weight="w", utility=u)
    ...
    def test_cost_and_route_feature(self):
        ...
        np.testing.assert_array_almost_equal(out.cells_to_cells["a"], np.array([0.0, -3.0, -9.0]))
    ...
    def test_no_features_uses_tiered_path_costs(self):
        ...
        u_out = route_utility(g, pairs, weight="w", utility=u)
        costs = tiered_path_costs(g, pairs, weight="w")
...
class AddEndpointUtilityTestCase(unittest.TestCase):
    ...
    def test_constant_only(self):
        ...
        r_u = route_utility(g, pairs, weight="w", utility=u)
    ...
    def test_destination_feature(self):
        ...
        # a→b: -1 + 0.5*20 = 9
        # a→c: -3 + 0.5*30 = 12
        np.testing.assert_array_almost_equal(full.cells_to_cells["a"], np.array([5.0, 9.0, 12.0]))
    ...
    def test_origin_feature(self):
        ...
        np.testing.assert_array_almost_equal(full.cells_to_cells["a"], np.array([1.0, 0.0, -2.0]))
    ...
    def test_combined_origin_dest_constant(self):
        ...
        # a→b: -1 + 2 + 1 + 10 = 12
        # a→c: -3 + 2 + 1 + 15 = 15
        np.testing.assert_array_almost_equal(full.cells_to_cells["a"], np.array([8.0, 12.0, 15.0]))
    ...
    def test_two_cells_one_node_origin_features_averaged(self):
        ...
        np.testing.assert_array_almost_equal(full.cells_to_cells["a"], np.array([150.0, 150.0]))
